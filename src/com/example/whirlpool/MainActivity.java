...
public class MainActivity extends FragmentActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		slideDrawer
				.setTrackHandle(findViewById(R.id.home_fast_settings_menu_btn));
		slideDrawer
				.setTrackHandle(findViewById(R.id.home_fridge_menu_btn));
		slideDrawer
				.setTrackHandle(findViewById(R.id.home_oven_menu_btn));
		slideDrawer
				.setTrackHandle(findViewById(R.id.home_settings_menu_btn));

		Fragment homeDataFragment = new HomeData();
		FragmentManager homeDataFragmentManager = getSupportFragmentManager();

		homeDataFragmentManager.beginTransaction()
				.replace(R.id.home_data_area_container, homeDataFragment)
				.commit();
	}
...
//			Fragment fragmentstatus = new FridgeStatus();
//			FragmentManager FridgeFragmentManager = getSupportFragmentManager();
//
//			FridgeFragmentManager.beginTransaction()
//					.add(R.id.status_fragment, fragmentstatus)
//					.commit();
//			
//
//			Fragment warning = new FridgeWarningStatus();
//			getSupportFragmentManager().beginTransaction()
//					.add(R.id.warnings_fragment, warning).commit();
//
//			Fragment timer = new FridgeTimerStatus();
//			getSupportFragmentManager().beginTransaction()
//					.add(R.id.timer_status_fragment, timer).commit();
			slideDrawerOpened();
	...
	private void settingsButtonSelected() {
		...
		settingsBtn.setBackgroundDrawable(getResources().getDrawable(
				R.drawable.button_border_remove));
		fridgeBtn.setBackgroundDrawable(getResources().getDrawable(
				R.drawable.button_border));
		ovenBtn.setBackgroundDrawable(getResources().getDrawable(
				R.drawable.button_border));
		fastSettingsBtn.setBackgroundDrawable(getResources().getDrawable(
				R.drawable.button_border));
	}
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			try {
				...
				if (e1.getX() - e2.getX() > SWIPE_MIN_DISTANCE
					...
					fridgeBtn.setBackgroundDrawable(getResources().getDrawable(
							R.drawable.button_border));
					settingsBtn.setBackgroundDrawable(getResources()
							.getDrawable(R.drawable.button_border));
					ovenBtn.setBackgroundDrawable(getResources().getDrawable(
							R.drawable.button_border));
					fastSettingsBtn.setBackgroundDrawable(getResources()
							.getDrawable(R.drawable.button_border));
					return true;
				}
			} catch (Exception e) {
	...
	public void onBackPressed() {
		/***
		 * Checks for is slidingDrawer is opened or not If opens it closes the
		 * sliding Drawer
		 */
		if (slideDrawer.isOpened()) {
			slideDrawer.close();
