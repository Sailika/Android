...
/**
 * Helper class to make server request for asset repost
 * 
 * @author Dileep | neuv
 * 
 */
public class AssetRepostHelper {

	private static final String TAG = "AssetRepostHelper";
	private Context context;

	/**
	 * @param context
	 */
	public AssetRepostHelper(Context context) {
