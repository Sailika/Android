...
/**
 * Helper class that connects to Whatsay server and fetches Groups List
 * 
 * @author Dileep | neuv
 * 
 */
public class GetGroupsListHelper {
    
    private final int GROUPS_LIST_BATCH_LIMIT = 1000;

    public GetGroupsListHelper() {
	super();
    }
	...
	try {
	    ...
	    StringBuilder urlBuilder = new StringBuilder(ServerConstants.NODE_SERVER_URL
		    + ServerConstants.GET_GROUPS_LIST + Constants.URL_SLASH + 0 + Constants.URL_SLASH
		    + GROUPS_LIST_BATCH_LIMIT);
