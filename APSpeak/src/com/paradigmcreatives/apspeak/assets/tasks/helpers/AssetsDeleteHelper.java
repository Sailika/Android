...
public class AssetsDeleteHelper {

	private static final String TAG = "AssetsDeleteHelper";
	private Context context;

	/**
	 * @param context
	 */
	public AssetsDeleteHelper(Context context) {
